...
corpus_dir = "../FRcorp"
output_dir = "/home/mfily/Documents/diagnoSTIC_XP/05_mesure_distance/RUFR_res/preprocessed_corpora"
...
for i in range (25):
    output_filename=f"RuFr_interfer_lay_{i}.pkl"
    lay_number=f"layer_{i}"
    df[['filename', 'speaker', lay_number, 'sentence', 'words', 'phones']].to_pickle(output_filename)
