...
# ----------------------------------
#
# The representations are normalized at corpus level, it would be interesting to see if it makes sense to normalize them at a speaker level
...
merged_label = pd.concat([group.merge(group, how="cross")
...
def align(x, y):
    ...
    return dtw(dist, keep_internals=True)
