...
df["level"] = df.apply(categorize, axis=1, cx='level_fr_x', cy='level_fr_y')
...
sns.boxplot(y='audio_cost_LD', data=df, x = 'same_speaker', ax = ax1, hue = 'level')
sns.boxplot(y='cost_LD', data=df, x = 'same_speaker', ax = ax2, hue = 'level')
sns.boxplot(y='R', data=df, x = 'same_speaker', ax = ax3, hue = 'level')
sns.boxplot(y='dist_A', data=df, x = 'same_speaker', ax = ax4, hue = 'level')
sns.boxplot(y='dist_N', data=df, x = 'same_speaker', ax = ax5, hue = 'level')
sns.boxplot(y='frechet_dist', data=df, x = 'same_speaker', ax = ax6, hue = 'level')
sns.boxplot(y='len_devxy', data=df, x = 'same_speaker', ax = ax7, hue = 'level')
for ax in [ax1, ax2, ax3, ax4, ax5, ax6, ax7]:
    ax.yaxis.set_label_text("")
fig.figure.savefig(f"{outsuf}_box_LVL_hue_{args.layer}.pdf", bbox_inches='tight')
