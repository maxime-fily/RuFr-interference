...
#Macro DATA
max_len = 0
for l in [5, 10, 16, 19, 20, 21, 22, 23, 24]:
...
#Initialize empty dataframe for data aggregation
    dg=pd.DataFrame()
    for i in [5, 10, 16, 19, 20, 21, 22, 23, 24]:
...
#19SPK
    ...
    plt.ylabel('point-by-point Eucl. dist.')
    x_value=new_x_mesh
    y_value1=DH["mean_point_SS"].iloc[2]
    z_value1=DH["std_point_SS"].iloc[2]
    y_value2=DH["mean_point_DS"].iloc[2]
    z_value2=DH["std_point_DS"].iloc[2]
    ...
    plt.ylabel('point-by-point Eucl. dist.')
    x_value=new_x_mesh
    y_value1=DH["mean_point_SL1"].iloc[2]
    z_value1=DH["std_point_SL1"].iloc[2]
    y_value2=DH["mean_point_DL1"].iloc[2]
    z_value2=DH["std_point_DL1"].iloc[2]
...
#8SPK
    ...
    plt.ylabel('point-by-point Eucl. dist.')
    x_value=new_x_mesh
    y_value1=D8["mean_point_SS"].iloc[2]
    z_value1=D8["std_point_SS"].iloc[2]
    y_value2=D8["mean_point_DS"].iloc[2]
    z_value2=D8["std_point_DS"].iloc[2]
    ...
    plt.ylabel('point-by-point Eucl. dist.')
    x_value=new_x_mesh
    y_value1=D8["mean_point_SL1"].iloc[2]
    z_value1=D8["std_point_SL1"].iloc[2]
    y_value2=D8["mean_point_DL1"].iloc[2]
    z_value2=D8["std_point_DL1"].iloc[2]
    ...
    plt.ylabel('point-by-point Eucl. dist.')
    x_value=new_x_mesh
    y_value1=D8["mean_point_SG"].iloc[2]
    z_value1=D8["std_point_SG"].iloc[2]
    y_value2=D8["mean_point_DG"].iloc[2]
    z_value2=D8["std_point_DG"].iloc[2]
...
#INDIV SPK
    ...
    plt.ylabel('point-by-point Eucl. dist.')
    x_value=new_x_mesh
    y_value1=DA[f"mean_point_dist_{c_it[0]}"].iloc[2]
    z_value1=DA[f"std_point_dist_{c_it[0]}"].iloc[2]
    y_value2=DA[f"mean_point_dist_{c_it[1]}"].iloc[2]
    z_value2=DA[f"std_point_dist_{c_it[1]}"].iloc[2]
    y_value3=DA[f"mean_point_dist_{c_it[2]}"].iloc[2]
    z_value3=DA[f"std_point_dist_{c_it[2]}"].iloc[2]
    y_value4=DA[f"mean_point_dist_{c_it[3]}"].iloc[2]
    z_value4=DA[f"std_point_dist_{c_it[3]}"].iloc[2]
    y_value5=DA[f"mean_point_dist_{c_it[4]}"].iloc[2]
    z_value5=DA[f"std_point_dist_{c_it[4]}"].iloc[2]
    y_value6=DA[f"mean_point_dist_{c_it[5]}"].iloc[2]
    z_value6=DA[f"std_point_dist_{c_it[5]}"].iloc[2]
    y_value7=DA[f"mean_point_dist_{c_it[6]}"].iloc[2]
    z_value7=DA[f"std_point_dist_{c_it[6]}"].iloc[2]
    y_value8=DA[f"mean_point_dist_{c_it[7]}"].iloc[2]
    z_value8=DA[f"std_point_dist_{c_it[7]}"].iloc[2]
    ...
    plt.ylabel('point-by-point Eucl. dist.')
    x_value=new_x_mesh
    y_value1=DA[f"mean_point_dist_{c_it[0]}"].iloc[3]
    z_value1=DA[f"std_point_dist_{c_it[0]}"].iloc[3]
    y_value2=DA[f"mean_point_dist_{c_it[1]}"].iloc[3]
    z_value2=DA[f"std_point_dist_{c_it[1]}"].iloc[3]
    y_value3=DA[f"mean_point_dist_{c_it[2]}"].iloc[3]
    z_value3=DA[f"std_point_dist_{c_it[2]}"].iloc[3]
    y_value4=DA[f"mean_point_dist_{c_it[3]}"].iloc[3]
    z_value4=DA[f"std_point_dist_{c_it[3]}"].iloc[3]
    y_value5=DA[f"mean_point_dist_{c_it[4]}"].iloc[3]
    z_value5=DA[f"std_point_dist_{c_it[4]}"].iloc[3]
    y_value6=DA[f"mean_point_dist_{c_it[5]}"].iloc[3]
    z_value6=DA[f"std_point_dist_{c_it[5]}"].iloc[3]
    y_value7=DA[f"mean_point_dist_{c_it[6]}"].iloc[3]
    z_value7=DA[f"std_point_dist_{c_it[6]}"].iloc[3]
    y_value8=DA[f"mean_point_dist_{c_it[7]}"].iloc[3]
    z_value8=DA[f"std_point_dist_{c_it[7]}"].iloc[3]
    plt.plot(x_value,y_value1, next(linecycler),linewidth=0.5,label=f"{c_it[0]}_{listeloc.loc[listeloc['ident'] == c_it[0],'L1'].iloc[0]}_{listeloc.loc[listeloc['ident'] == c_it[0],'sex'].iloc[0]}")
    plt.fill_between(x_value, y_value1 - z_value1, y_value1 + z_value1, alpha=0.1)
    plt.plot(x_value,y_value2, next(linecycler),linewidth=0.5,label=f"{c_it[1]}_{listeloc.loc[listeloc['ident'] == c_it[1],'L1'].iloc[0]}_{listeloc.loc[listeloc['ident'] == c_it[1],'sex'].iloc[0]}")
    plt.fill_between(x_value, y_value2 - z_value2, y_value2 + z_value2, alpha=0.1)
    ...
    plt.ylabel('point-by-point Eucl. dist.')
    x_value=new_x_mesh
    y_value1=DA[f"mean_point_dist_{c_it[0]}"].iloc[4]
    z_value1=DA[f"std_point_dist_{c_it[0]}"].iloc[4]
    y_value2=DA[f"mean_point_dist_{c_it[1]}"].iloc[4]
    z_value2=DA[f"std_point_dist_{c_it[1]}"].iloc[4]
    y_value3=DA[f"mean_point_dist_{c_it[2]}"].iloc[4]
    z_value3=DA[f"std_point_dist_{c_it[2]}"].iloc[4]
    y_value4=DA[f"mean_point_dist_{c_it[3]}"].iloc[4]
    z_value4=DA[f"std_point_dist_{c_it[3]}"].iloc[4]
    y_value5=DA[f"mean_point_dist_{c_it[4]}"].iloc[4]
    z_value5=DA[f"std_point_dist_{c_it[4]}"].iloc[4]
    y_value6=DA[f"mean_point_dist_{c_it[5]}"].iloc[4]
    z_value6=DA[f"std_point_dist_{c_it[5]}"].iloc[4]
    y_value7=DA[f"mean_point_dist_{c_it[6]}"].iloc[4]
    z_value7=DA[f"std_point_dist_{c_it[6]}"].iloc[4]
    y_value8=DA[f"mean_point_dist_{c_it[7]}"].iloc[4]
    z_value8=DA[f"std_point_dist_{c_it[7]}"].iloc[4]
    plt.plot(x_value,y_value1, next(linecycler),linewidth=0.5,label=f"{c_it[0]}_{listeloc.loc[listeloc['ident'] == c_it[0],'L1'].iloc[0]}_{listeloc.loc[listeloc['ident'] == c_it[0],'sex'].iloc[0]}")
    plt.fill_between(x_value, y_value1 - z_value1, y_value1 + z_value1, alpha=0.1)
    plt.plot(x_value,y_value2, next(linecycler),linewidth=0.5,label=f"{c_it[1]}_{listeloc.loc[listeloc['ident'] == c_it[1],'L1'].iloc[0]}_{listeloc.loc[listeloc['ident'] == c_it[1],'sex'].iloc[0]}")
    plt.fill_between(x_value, y_value2 - z_value2, y_value2 + z_value2, alpha=0.1)
    ...
    plt.ylabel('point-by-point Eucl. dist.')
    x_value=new_x_mesh
    y_value1=DA[f"mean_point_dist_{c_it[0]}"].iloc[0]
    z_value1=DA[f"std_point_dist_{c_it[0]}"].iloc[0]
    y_value2=DA[f"mean_point_dist_{c_it[1]}"].iloc[0]
    z_value2=DA[f"std_point_dist_{c_it[1]}"].iloc[0]
    y_value3=DA[f"mean_point_dist_{c_it[2]}"].iloc[0]
    z_value3=DA[f"std_point_dist_{c_it[2]}"].iloc[0]
    y_value4=DA[f"mean_point_dist_{c_it[3]}"].iloc[0]
    z_value4=DA[f"std_point_dist_{c_it[3]}"].iloc[0]
    y_value5=DA[f"mean_point_dist_{c_it[4]}"].iloc[0]
    z_value5=DA[f"std_point_dist_{c_it[4]}"].iloc[0]
    y_value6=DA[f"mean_point_dist_{c_it[5]}"].iloc[0]
    z_value6=DA[f"std_point_dist_{c_it[5]}"].iloc[0]
    y_value7=DA[f"mean_point_dist_{c_it[6]}"].iloc[0]
    z_value7=DA[f"std_point_dist_{c_it[6]}"].iloc[0]
    y_value8=DA[f"mean_point_dist_{c_it[7]}"].iloc[0]
    z_value8=DA[f"std_point_dist_{c_it[7]}"].iloc[0]
    plt.plot(x_value,y_value1, next(linecycler),linewidth=0.5,label=f"{c_it[0]}_{listeloc.loc[listeloc['ident'] == c_it[0],'L1'].iloc[0]}_{listeloc.loc[listeloc['ident'] == c_it[0],'sex'].iloc[0]}")
    plt.fill_between(x_value, y_value1 - z_value1, y_value1 + z_value1, alpha=0.1)
    plt.plot(x_value,y_value2, next(linecycler),linewidth=0.5,label=f"{c_it[1]}_{listeloc.loc[listeloc['ident'] == c_it[1],'L1'].iloc[0]}_{listeloc.loc[listeloc['ident'] == c_it[1],'sex'].iloc[0]}")
    plt.fill_between(x_value, y_value2 - z_value2, y_value2 + z_value2, alpha=0.1)
